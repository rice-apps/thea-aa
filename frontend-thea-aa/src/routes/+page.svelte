...
<main class="flex">
	<aside>
		...
		<div>
			<Button
				on:click={() => {
					showContaminated = !showContaminated
				}}>Contaminated Sites</Button
			>
			<Button
				on:click={() => {
					showEmissionEvents = !showEmissionEvents
				}}>Emission Events</Button
			>
		</div>
	...
	<div>
		<Map
			contaminatedSite={showContaminated ? data.contaminatedSites : null}
			emissionEvent={showEmissionEvents ? data.emissionEvents : null}
		/>
	</div>
</main>
